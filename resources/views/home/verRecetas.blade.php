...
<section class="text-gray-700 body-font overflow-hidden bg-white">
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="{{asset('storage/' . $recetas->images)}}">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div class="mb-4">
              ...
              {{-- <p class="leading-relaxed">{{$recetas->ingredients}}</p> --}}
              <ul>
          ...
          <div class="mb-4">
              ...
              {{-- <p class="leading-relaxed">{{$recetas->preparation}}</p> --}}
              <div class="text-description">
                <ol>
                    <li><i class="fas fa-hand-sparkles fa-fw"></i> {{ $recetas->preparation }} </li>
                    <li><i class="fas fa-cut fa-fw"></i> Cortar los ingredientes en trozos pequeños.</li>
                    <li><i class="fas fa-utensil-spoon fa-fw"></i> Cocinar a fuego medio durante 20 minutos.</li>
                    <li><i class="fas fa-leaf fa-fw"></i> Agregar hierbas frescas y mezclar bien.</li>
                </ol>
            </div>
          </div>
          <div class="flex">
